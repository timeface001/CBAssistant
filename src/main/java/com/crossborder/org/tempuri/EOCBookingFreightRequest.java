...
public class EOCBookingFreightRequest  implements java.io.Serializable {
    private Authentication authentication;

    private String equickWBNo;

    public EOCBookingFreightRequest() {
    }
    ...
    /**
     * Gets the authentication value for this EOCBookingFreightRequest.
     * 
    ...
    /**
     * Sets the authentication value for this EOCBookingFreightRequest.
     * 
    ...
    /**
     * Gets the equickWBNo value for this EOCBookingFreightRequest.
     * 
     * @return equickWBNo
     */
    ...
    /**
     * Sets the equickWBNo value for this EOCBookingFreightRequest.
     * 
     * @param equickWBNo
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof EOCBookingFreightRequest)) return false;
        EOCBookingFreightRequest other = (EOCBookingFreightRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EOCBookingFreightRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "EOCBookingFreightRequest"));
