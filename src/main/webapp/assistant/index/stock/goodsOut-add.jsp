...
<div class="pd-20">
    <div class="Huiform">
        <form id="goodsOutForm" class="form form-horizontal">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>订单ItemId：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="多个id用逗号隔开" id="orderItemId"
                           name="orderItemId">
                </div>
            </div>
            <div class="row cl">
...
<script type="text/javascript">
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            ...
            url: "<%=request.getContextPath()%>/stock/addGoodsOut",
