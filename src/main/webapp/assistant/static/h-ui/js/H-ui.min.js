...
!(function (c) {
    var g = "iCheck", e = g + "-helper", q = "checkbox", a = "radio", s = "checked", x = "un" + s, i = "disabled", h = "determinate", b = "in" + h, r = "update", t = "type", d = "click", w = "touchbegin.i touchend.i", p = "addClass", f = "removeClass", l = "trigger", z = "label", o = "cursor", n = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent);
    c.fn[g] = function (N, E) {
        ...
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(N)) {
            ...
            if (typeof N == "object" || !N) {
                var F = c.extend({
                    ...
                    labelHover: true
                }, N), G = F.handle, I = F.hoverClass || "hover", M = F.focusClass || "focus", K = F.activeClass || "active", C = !!F.labelHover, H = F.labelHoverClass || "hover", D = ("" + F.increaseArea).replace("%", "") | 0;
                if (G == q || G == a) {
                    J = 'input[type="' + G + '"]'
                }
                if (D < -50) {
                ...
                return L.each(function () {
                    ...
                    var R = this, O = R.id, S = -D + "%", aa = 100 + (D * 2) + "%", T = {
                        ...
                        position: "absolute",
                        opacity: 0
                    }, V = R[t] == q ? F.checkboxClass || "i" + q : F.radioClass || "i" + a, X = c(z + '[for="' + O + '"]').add(Z.closest(z)), W = !!F.aria, Q = g + "-" + Math.random().toString(36).substr(2, 6), Y = '<div class="' + V + '" ' + (W ? 'role="' + R[t] + '" ' : ""), P;
                    if (W) {
                        X.each(function () {
                            Y += 'aria-labelledby="';
                            if (this.id) {
    ...
    function k(K, D, B) {
        var G = K[0], M = K.parent(), L = D == s, C = D == b, H = D == i, N = C ? h : L ? x : "enabled", F = m(K, N + j(G[t])), J = m(K, D + j(G[t]));
        if (G[D] !== true) {
    ...
    function y(I, D, B) {
        var F = I[0], K = I.parent(), J = D == s, C = D == b, G = D == i, L = C ? h : J ? x : "enabled", E = m(I, L + j(F[t])), H = m(I, D + j(F[t]));
        if (F[D] !== false) {
            if (C || !B || B == "force") {
                F[D] = false
            }
                    ...
                    p.find("label").on("mousedown touchstart", function (r) {
                        ...
                        if (q.closest(".has-switch").is(".deactivate")) {
                            ...
                            q.on("mousemove touchmove", function (x) {
                                var s = a(this).closest(".switch"), u = (x.pageX || x.originalEvent.targetTouches[0].pageX) - s.offset().left, v = (u / s.width()) * 100, w = 25, t = 75;
                                d = true;
                                if (v < w) {
                                    v = w
                                } else {
